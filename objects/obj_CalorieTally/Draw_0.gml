...
if (text1) {draw_text_ext(480, 134, "Day #" + string(global.cycles) + " Complete!", 24, 856);}
if (text2) {draw_text_ext(480, 352, "You've cooked up: " + string(risingCalories) + " Calories!", 24, 856);}
