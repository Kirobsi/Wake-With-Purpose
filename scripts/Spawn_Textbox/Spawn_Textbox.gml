...
function create_textbox(text_row, _hasBackground = true, _hAlignment = fa_left, _canAdvance = true, _positionOverride = false, position_x = 7, position_y = 7, _width = 646) {
