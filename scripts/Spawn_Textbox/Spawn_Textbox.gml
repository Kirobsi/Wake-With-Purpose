...
function create_textbox(text_row, _autoRestoreControl = true, _hasBackground = true, _hAlignment = fa_left, _canAdvance = true, _positionOverride = false, position_x = 14, position_y = 14, _width = 631) {
